//Sun Oct 13 2024 10:46:00 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
const _0x22b906 = _0x37042b("美团"),
  _0x1aef1b = require("got"),
  _0x5585f1 = "meituan",
  _0x334ab0 = ["\n", "&", "@"],
  _0xcaa1dd = [_0x5585f1 + "Cookie"],
  _0x10315b = process.env[_0x5585f1 + "AutoWithdraw"] || "true",
  _0x2e8789 = 8000,
  _0x446454 = 3;
...
let _0x526f9f = "114.07" + _0x22b906.randomString(12, _0x46ec7d),
  _0x28c015 = "22.52" + _0x22b906.randomString(13, _0x46ec7d),
...
let _0x5c1205 = [];
function _0x598e1a(_0x30f343) {
  return Buffer.from(_0x30f343, "utf8").toString("base64");
}
class _0x1ceac5 {
  constructor() {
    this.index = _0x22b906.userIdx++;
    this.name = "";
    this.valid = true;
    const _0x272b30 = {
      limit: 0
    ...
    this.got = _0x1aef1b.extend(_0x1586fa);
  }
  log(_0x469119, _0x27d901 = {}) {
    var _0x22316c = "",
      _0x26b0de = _0x22b906.userCount.toString().length;
    if (this.index) {
      _0x22316c += "账号[" + _0x22b906.padStr(this.index, _0x26b0de) + "]";
    }
    if (this.name) {
      _0x22316c += "[" + this.name + "]";
    }
    _0x22b906.log(_0x22316c + _0x469119, _0x27d901);
  }
...
class _0xda5687 extends _0x1ceac5 {
  constructor(_0x3d39e1) {
    super();
    if (_0x3d39e1.startsWith("token=")) {
      _0x3d39e1 = _0x3d39e1.replace("token=", "");
    }
    this.token = _0x3d39e1;
    this.t_earnDaily = 0;
    this.uuid = _0x22b906.randomPattern("186ebxxxxxxxx-22e49fxxxxxxxx-0-0-186ebxxxxxxxx");
    this.openid = _0x22b906.randomString(7, _0x7ddba3) + "-" + _0x22b906.randomString(20, _0x7ddba3);
  ...
  encode_riskForm() {
    return _0x598e1a(JSON.stringify(this.get_riskForm()));
  }
  async getLoginedUserInfo(_0x35681b = {}) {
    ...
    try {
      ...
      let {
        result: _0xaae760
      } = await this.request(_0x230731);
      if (_0xaae760?.["mobile"]) {
        _0x49659e = true;
        this.name = _0xaae760.mobile;
        this.userId = Number(_0xaae760.userId);
        this.log("登录成功");
      } else {
        const _0x410003 = {
          notify: true
        };
        this.log("获取账号信息失败, ck可能失效", _0x410003);
      }
    } catch (_0x59ae8c) {
  ...
  async inviteFetchcoupon(_0x2ef46e = {}) {
    try {
      ...
      let {
        ...
        _0x401b13 = _0x22b906.get(_0x3455a6, "code", -1),
        _0x325d08 = _0x22b906.get(_0x3455a6, "subcode", -1);
  ...
  async gundamGrabV4(_0x3aa2cc, _0x411caf = {}) {
    try {
      ...
      let {
        ...
        _0x33b1db = _0x22b906.get(_0x3fbe4e, "code", -1);
      if (_0x33b1db == 0) {
    ...
    try {
      let _0x5e8e17 = {
          ...
          searchParams: {
            ...
            cType: _0x22b906.get(_0x4aeb53, "cType", "wm_wxapp"),
            wm_appversion: _0x22b906.get(_0x4aeb53, "wm_appversion", "9.19.6"),
            gdPageId: _0x22b906.get(_0x4aeb53, "gdPageId", "460584"),
            token: this.token,
            userId: this.userId,
            uuid: this.uuid
          },
        ...
        _0x1707cd = _0x22b906.get(_0x3773ac, "code", -1);
      if (_0x1707cd == 0) {
        let _0x4d6125 = [];
    ...
    try {
      let _0x534229 = {
          ...
          searchParams: {
            ...
            isInDpEnv: 0,
            isMini: 1,
            cType: _0x22b906.get(_0x4aaddf, "cType", "wm_wxapp")
          }
        },
        {
          result: _0x18ecd7
        } = await this.request(_0x534229),
        _0x35ced4 = _0x22b906.get(_0x18ecd7, "code", -1);
      if (_0x35ced4 == 0) {
    ...
    try {
      ...
      let _0xa47678 = {
          ...
          searchParams: {
            isInDpEnv: 0,
            isMini: 1,
            cType: _0x22b906.get(_0x37fed9, "cType", "wm_wxapp")
          },
          json: {
        ...
        _0x40ef6b = _0x22b906.get(_0x3ff7e4, "code", -1);
      if (_0x40ef6b == 0) {
  ...
  async ttsqEntry(_0x367790, _0x38214d = {}) {
    try {
      ...
      let {
        ...
        _0x2b7720 = _0x22b906.get(_0x1a6172, "code", -1);
      if (_0x2b7720 == 0) {
  ...
  async ttsqDoAction(_0x463e17, _0x131176, _0x118b6f = {}) {
    try {
      let _0x26b031 = {
        ...
        _0x140d35 = _0x22b906.get(_0x2be282, "code", -1);
      if (_0x140d35 == 0) {
    ...
    try {
      let _0x525433 = {
          ...
          searchParams: {
            ...
            ctype: _0x22b906.get(_0x44b200, "ctype", "wm_wxapp"),
            isInDpEnv: 0
          }
        },
        {
        ...
        _0x284c2b = _0x22b906.get(_0x2d0a2c, "code", -1);
      if (_0x284c2b == 0) {
  ...
  async clockInSign(_0x1bacd8, _0x4350e7 = {}) {
    try {
      ...
      let _0x4fa2d2 = {
          ...
          searchParams: {
            isMini: 1,
            ctype: _0x22b906.get(_0x4350e7, "ctype", "wm_wxapp"),
            isInDpEnv: 0
          },
          json: _0x27d89e
        },
        ...
        _0x546b73 = _0x22b906.get(_0x437883, "code", -1);
      if (_0x546b73 == 0) {
  ...
  async getCardInfo(_0x4c56e5, _0x12ff15 = {}) {
    try {
      ...
      let {
        ...
        _0x29533a = _0x22b906.get(_0x4ff9dc, "code", -1);
      if (_0x29533a == 0) {
          ...
          if (!_0x4d5629.includes(_0x119046?.["code"]?.["toString"]())) {
            if (_0x119046.taskConf) {
              ...
              if (_0x3b588a.isCheckNgSignature) {
                _0x22b906.log("任务[" + _0x119046.title + "] -- 有强验证, 跳过");
                continue;
              }
            }
            if (!_0x119046?.["taskRuleVos"]?.["length"]) {
              _0x22b906.log("任务[" + _0x119046.title + "] -- " + _0x119046.msg);
              continue;
            }
              ...
              if (_0xdd5f59.status == "PRIZE_SUCC" || _0xdd5f59.status == "DELETE") {
                ...
                if (_0xdd5f59?.["status"] == "CAN_RECEIVE") {
                  ...
                  if (_0x3b93c8.limitTime) {
                    ...
                    Date.now() < _0x1cba73 && (_0xc2d53d = false, _0x22b906.log("任务[" + _0x119046.title + "]冷却中, [" + _0x22b906.time("hh:mm:ss", _0x1cba73) + "]后可完成"));
                  } else {
                    if (_0x3b93c8?.["timeLimits"]?.["length"]) {
                      let _0x535313 = new Date(_0x22b906.time("yyyy-MM-dd 00:00:00")).getTime(),
                        _0xbf291d = Date.now();
                      for (let _0x589e2a of _0x3b93c8.timeLimits) {
                        ...
                        _0x2bb3d9 += _0x535313;
                        _0xd167fd += _0x535313;
                        (_0xbf291d < _0x2bb3d9 || _0xbf291d >= _0xd167fd) && (_0xc2d53d = false, _0x22b906.log("任务[" + _0x119046.title + "]不在时间段中: " + _0x22b906.time("hh:mm:ss", _0x2bb3d9) + "到" + _0x22b906.time("hh:mm:ss", _0xd167fd)));
                      }
                    }
                  }
  ...
  async startUserTask(_0x322fad, _0x43c073, _0x509519, _0x30c81b = {}) {
    try {
      let _0x59e2cd = {
          ...
          headers: {
            "M-TRACEID": "32358943431" + _0x22b906.randomString(8, _0x46ec7d)
          }
        },
        {
          result: _0x31db3a
      ...
      if (_0x31db3a?.["code"] == 0) {
        ...
        if (_0x1a449e.staySeconds) {
          ...
          await _0x22b906.wait(_0x29f313);
        } else {
    ...
    try {
      ...
      let _0x2b9f1e = {
          ...
          searchParams: {
            ...
            nonceStr: _0x22b906.randomString(16),
        ...
        _0x5112ea = _0x22b906.get(_0xd1d6f5, "code", -1);
      if (_0x5112ea == 0) {
  ...
  async earnDailyPost(_0x63ebd1 = {}) {
    ...
    try {
      ...
      await _0x22b906.wait_gap_interval(this.t_earnDaily, _0xba841e);
    ...
    try {
      ...
      };
      {
        let {
          ...
          _0x2ea240 = _0x22b906.get(_0x592747, "code", -1);
        if (_0x2ea240 == 200) {
      ...
      }
      {
        let {
          ...
          _0x40af9f = _0x22b906.get(_0x2dcf01, "code", -1);
        if (_0x40af9f == 200) {
      ...
      }
      {
        let {
          ...
          _0x1c505c = _0x22b906.get(_0x5e46fe, "code", -1);
        if (_0x1c505c == 200) {
      ...
      }
      {
        let {
          ...
          _0x3083c2 = _0x22b906.get(_0x2abf23, "code", -1);
        if (_0x3083c2 == 200) {
  ...
  async earnDaily_coinInfo(_0x199e6a = {}) {
    try {
      ...
      let {
        ...
        _0x44c40c = _0x22b906.get(_0x27d6c3, "code", -1);
      if (_0x44c40c == 200) {
  ...
  async earnDaily_coinExchange(_0x58cef9, _0x254573 = {}) {
    try {
      ...
      let {
        ...
        _0x45bf5e = _0x22b906.get(_0x1a6288, "code", -1);
      if (_0x45bf5e == 200) {
  ...
  async earnDaily_sign(_0x3d5e41 = {}) {
    try {
      ...
      let {
        ...
        _0x4e4621 = _0x22b906.get(_0x504512, "code", -1);
      if (_0x4e4621 == 200) {
  ...
  async earnDaily_do_task(_0x35ed09, _0xc19b42 = {}) {
    try {
      ...
      let {
        ...
        _0xae2c = _0x22b906.get(_0x21b730, "code", -1);
      if (_0xae2c == 200) {
  ...
  async earnDaily_get_reward(_0x1ac71d, _0x1c1902 = {}) {
    try {
      ...
      let {
        ...
        _0x177b0e = _0x22b906.get(_0x3cf580, "code", -1);
      if (_0x177b0e == 200) {
  ...
  async earnDaily_redbag(_0x1c7105 = {}) {
    try {
      ...
      let {
        ...
        _0x2b62b5 = _0x22b906.get(_0x34ab51, "code", -1);
      if (_0x2b62b5 == 200) {
  ...
  async earnDaily_draw(_0x55ce4d = {}) {
    try {
      ...
      let {
        ...
        _0x431812 = _0x22b906.get(_0xb8aef8, "code", -1);
      if (_0x431812 == 200) {
  ...
  async earnDaily_get_withdraw_list(_0x10e92c = {}) {
    try {
      ...
      let {
        ...
        _0xc82cdf = _0x22b906.get(_0x2e6e74, "code", -1);
      if (_0xc82cdf == 200) {
  ...
  async earnDaily_withdraw(_0x4eea60, _0x2a2f1c = {}) {
    ...
    try {
      ...
      let {
        ...
        _0x4a8527 = _0x22b906.get(_0x2de092, "code", -1);
      if (_0x4a8527 == 200) {
        _0x2eb0d7 = true;
        const _0x535719 = {
          notify: true
    ...
    try {
      ...
      let _0x520bae = {
        ...
        json: {
          ...
          t: "1",
          c: "2",
          sessionId: "187a" + _0x22b906.randomPattern("xxxxxxx-xxx-xxx-xxx"),
          referrer: "",
          fingerprintFromH5: "eJxVV" + _0x22b906.randomString(_0x5b3fae, _0x7ddba3)
        }
      };
  ...
  async walletMainpage(_0xaa2e76 = {}) {
    try {
      ...
      let {
        ...
        _0x3251e2 = _0x22b906.get(_0x41c1a8, "status", -1);
...
!(async () => {
  ...
  await _0x5b1565();
  _0x22b906.read_env(_0xda5687);
  _0x22b906.log("\n-------------------------------------");
  _0x10315b == "false" || !_0x10315b ? _0x22b906.log("APP每日赚钱设置为: 不随机提现") : _0x22b906.log("APP每日赚钱设置为: 每日随机提现");
  _0x22b906.log("-------------------------------------");
  for (let _0x132c6f of _0x22b906.userList) {
    await _0x132c6f.userTask();
  }
})().catch(_0x105a2b => _0x22b906.log(_0x105a2b)).finally(() => _0x22b906.exitNow());
  ...
  try {
    ...
    if (_0x5156f2?.["code"] == 0) {
      ...
      if (_0x5156f2?.["commonNotify"] && _0x5156f2.commonNotify.length > 0) {
        ...
        _0x22b906.log(_0x5156f2.commonNotify.join("\n") + "\n", _0x35d35e);
      }
      _0x5156f2?.["commonMsg"] && _0x5156f2.commonMsg.length > 0 && _0x22b906.log(_0x5156f2.commonMsg.join("\n") + "\n");
      if (_0x5156f2[_0x5a1316]) {
        let _0x293740 = _0x5156f2[_0x5a1316];
        _0x293740.status == 0 ? _0x426ebd >= _0x293740.version ? (_0x467776 = true, _0x22b906.log(_0x293740.msg[_0x293740.status]), _0x22b906.log(_0x293740.updateMsg), _0x22b906.log("现在运行的脚本版本是：" + _0x426ebd + "，最新脚本版本：" + _0x293740.latestVersion)) : _0x22b906.log(_0x293740.versionMsg) : _0x22b906.log(_0x293740.msg[_0x293740.status]);
      } else {
        _0x22b906.log(_0x5156f2.errorMsg);
      }
    }
  } catch (_0x1c6903) {
    _0x22b906.log(_0x1c6903);
  } finally {
    return _0x467776;
  }
}
async function _0x5b1565() {
  ...
  try {
    ...
    _0x22b906.log(_0x208ffe);
  } finally {
    return _0x4a3645;
  }
}
function _0x37042b(_0x149ce0) {
  return new class {
    constructor(_0x47c048) {
      this.name = _0x47c048;
    ...
    log(_0x4d84ad, _0x166fdd = {}) {
      const _0x5a3668 = {
        console: true
      };
      Object.assign(_0x5a3668, _0x166fdd);
      if (_0x5a3668.time) {
        let _0x2906fc = _0x5a3668.fmt || "hh:mm:ss";
        _0x4d84ad = "[" + this.time(_0x2906fc) + "]" + _0x4d84ad;
      }
      if (_0x5a3668.notify) {
        this.notifyStr.push(_0x4d84ad);
      }
      if (_0x5a3668.console) {
        console.log(_0x4d84ad);
      }
    }
    read_env(_0x17f8aa) {
      let _0xc78f = _0xcaa1dd.map(_0x92bcf9 => process.env[_0x92bcf9]);
      for (let _0x4c430f of _0xc78f.filter(_0x34b74b => !!_0x34b74b)) {
        let _0x4db3b8 = _0x334ab0.filter(_0xedc3bf => _0x4c430f.includes(_0xedc3bf)),
          _0x5e8d2a = _0x4db3b8.length > 0 ? _0x4db3b8[0] : _0x334ab0[0];
        for (let _0x1a1997 of _0x4c430f.split(_0x5e8d2a).filter(_0x23a8ae => !!_0x23a8ae)) {
          this.userList.push(new _0x17f8aa(_0x1a1997));
        }
      }
      ...
      if (!this.userCount) {
        ...
        this.log("未找到变量，请检查变量" + _0xcaa1dd.map(_0x2dddf1 => "[" + _0x2dddf1 + "]").join("或"), _0x5ce66b);
        return false;
      }
      this.log("共找到" + this.userCount + "个账号");
      return true;
    }
    async threads(_0x40e5c6, _0xbbc5e3, _0x4870e6 = {}) {
      while (_0xbbc5e3.idx < _0x22b906.userList.length) {
        let _0x428ae5 = _0x22b906.userList[_0xbbc5e3.idx++];
        if (!_0x428ae5.valid) {
          continue;
        }
        await _0x428ae5[_0x40e5c6](_0x4870e6);
      }
    }
    async threadTask(_0x1ac884, _0x2caf26) {
      let _0x1c86dc = [];
      const _0x40b05e = {
        idx: 0
      };
      while (_0x2caf26--) {
        _0x1c86dc.push(this.threads(_0x1ac884, _0x40b05e));
      }
      await Promise.all(_0x1c86dc);
    }
    time(_0x30492c, _0x15cb8c = null) {
      let _0x25f220 = _0x15cb8c ? new Date(_0x15cb8c) : new Date(),
        _0x43c672 = {
          "M+": _0x25f220.getMonth() + 1,
          "d+": _0x25f220.getDate(),
          "h+": _0x25f220.getHours(),
          "m+": _0x25f220.getMinutes(),
          "s+": _0x25f220.getSeconds(),
          "q+": Math.floor((_0x25f220.getMonth() + 3) / 3),
          S: this.padStr(_0x25f220.getMilliseconds(), 3)
        };
      /(y+)/.test(_0x30492c) && (_0x30492c = _0x30492c.replace(RegExp.$1, (_0x25f220.getFullYear() + "").substr(4 - RegExp.$1.length)));
      for (let _0x167905 in _0x43c672) new RegExp("(" + _0x167905 + ")").test(_0x30492c) && (_0x30492c = _0x30492c.replace(RegExp.$1, 1 == RegExp.$1.length ? _0x43c672[_0x167905] : ("00" + _0x43c672[_0x167905]).substr(("" + _0x43c672[_0x167905]).length)));
      return _0x30492c;
    }
    async showmsg() {
      if (!this.notifyFlag) {
      ...
      var _0xa94b6f = require("./sendNotify");
      this.log("\n============== 推送 ==============");
      await _0xa94b6f.sendNotify(this.name, this.notifyStr.join("\n"));
    }
    padStr(_0x252f6e, _0x58dbfc, _0x174e13 = {}) {
      let _0x2fc522 = _0x174e13.padding || "0",
        _0x565740 = _0x174e13.mode || "l",
        _0xff7d35 = String(_0x252f6e),
        _0x46e309 = _0x58dbfc > _0xff7d35.length ? _0x58dbfc - _0xff7d35.length : 0,
        _0x27969d = "";
      for (let _0x11dfb3 = 0; _0x11dfb3 < _0x46e309; _0x11dfb3++) {
        _0x27969d += _0x2fc522;
      }
      _0x565740 == "r" ? _0xff7d35 = _0xff7d35 + _0x27969d : _0xff7d35 = _0x27969d + _0xff7d35;
      return _0xff7d35;
    }
    json2str(_0x3ca76a, _0x9eae80, _0x5d8a30 = false) {
      let _0x3241e2 = [];
      for (let _0x4e40b7 of Object.keys(_0x3ca76a).sort()) {
        let _0x5c3092 = _0x3ca76a[_0x4e40b7];
        if (_0x5c3092 && _0x5d8a30) {
          _0x5c3092 = encodeURIComponent(_0x5c3092);
        }
        _0x3241e2.push(_0x4e40b7 + "=" + _0x5c3092);
      }
      return _0x3241e2.join(_0x9eae80);
    }
    str2json(_0x2a54e8, _0x3bcfdb = false) {
      let _0x2cfb8d = {};
      for (let _0x5cd28e of _0x2a54e8.split("&")) {
        if (!_0x5cd28e) {
          continue;
        }
        let _0x4d085a = _0x5cd28e.indexOf("=");
        if (_0x4d085a == -1) {
          continue;
        }
        let _0x8848e9 = _0x5cd28e.substr(0, _0x4d085a),
          _0x1c0e46 = _0x5cd28e.substr(_0x4d085a + 1);
        if (_0x3bcfdb) {
          _0x1c0e46 = decodeURIComponent(_0x1c0e46);
        }
        _0x2cfb8d[_0x8848e9] = _0x1c0e46;
      }
      return _0x2cfb8d;
    }
    randomPattern(_0x5a0610, _0x8638f4 = "abcdef0123456789") {
      let _0x461092 = "";
      for (let _0x111eae of _0x5a0610) {
        if (_0x111eae == "x") {
          _0x461092 += _0x8638f4.charAt(Math.floor(Math.random() * _0x8638f4.length));
        } else {
          _0x111eae == "X" ? _0x461092 += _0x8638f4.charAt(Math.floor(Math.random() * _0x8638f4.length)).toUpperCase() : _0x461092 += _0x111eae;
        }
      }
      return _0x461092;
    }
    randomString(_0x2c9d1, _0x267b7f = "abcdef0123456789") {
      let _0xd5c379 = "";
      for (let _0x559c50 = 0; _0x559c50 < _0x2c9d1; _0x559c50++) {
        _0xd5c379 += _0x267b7f.charAt(Math.floor(Math.random() * _0x267b7f.length));
      }
      return _0xd5c379;
    }
    randomList(_0x4b04e3) {
      let _0x4188db = Math.floor(Math.random() * _0x4b04e3.length);
      return _0x4b04e3[_0x4188db];
    }
    wait(_0x590103) {
      return new Promise(_0x50a543 => setTimeout(_0x50a543, _0x590103));
    }
    async exitNow() {
      await this.showmsg();
      let _0x446d44 = Date.now(),
        _0x1e6686 = (_0x446d44 - this.startTime) / 1000;
      this.log("");
      const _0x54e22b = {
        time: true
      };
      this.log("[" + this.name + "]运行结束，共运行了" + _0x1e6686 + "秒", _0x54e22b);
      process.exit(0);
    }
    get(_0x256bf5, _0x389be2, _0x12b5ac = "") {
      let _0x3e3b63 = _0x12b5ac;
      _0x256bf5?.["hasOwnProperty"](_0x389be2) && (_0x3e3b63 = _0x256bf5[_0x389be2]);
      return _0x3e3b63;
    }
    pop(_0x93dc16, _0x1f976b, _0x4e1e2d = "") {
      let _0x89f741 = _0x4e1e2d;
      _0x93dc16?.["hasOwnProperty"](_0x1f976b) && (_0x89f741 = _0x93dc16[_0x1f976b], delete _0x93dc16[_0x1f976b]);
      return _0x89f741;
    }
    copy(_0x238042) {
      return Object.assign({}, _0x238042);
    }
    async wait_gap_interval(_0x17df18, _0x19ae54) {
      let _0x26c0a2 = Date.now() - _0x17df18;
      _0x26c0a2 < _0x19ae54 && (await this.wait(_0x19ae54 - _0x26c0a2));
    }
  }(_0x149ce0);
}